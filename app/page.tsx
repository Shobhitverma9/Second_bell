...
export default function Home() {
  ...
  return (
    <main>
      ...
      {/* ── OUR MISSION (teal card + photo, Goonj-style) ────── */}
      <section className="bg-paper">
        <div className="mx-auto max-w-7xl px-5 sm:px-8 py-16 sm:py-24">
          <div className="grid md:grid-cols-2 gap-0 rounded-2xl overflow-hidden shadow-xl">
            {/* Teal text card */}
            <div className="bg-teal p-10 sm:p-14 flex flex-col justify-center">
              ...
              <Link
                href="/about"
                className="mt-8 inline-flex self-start items-center gap-2 rounded-full border-2 border-white/40 px-6 py-2.5 text-sm font-semibold text-white hover:bg-white/10 transition-colors"
              >
                Learn About Us →
              </Link>
            </div>
            ...
            <div className="relative min-h-[320px]">
              <Image
                ...
                alt="An Indian family at their home"
                fill
                className="object-cover"
              />
            </div>
      ...
      {/* ── WHAT WE SOLVE — image cards (Goonj-style) ───────── */}
      <section className="bg-paper-dim">
        <div className="mx-auto max-w-7xl px-5 sm:px-8 py-16 sm:py-24">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-5">
            {/* Colored category card */}
            <div className="rounded-xl bg-marigold p-8 flex items-end min-h-[240px]">
              <div>
                <p className="text-xs font-bold text-ink/60 uppercase tracking-widest mb-2">
                  Program 01
                </p>
                ...
                <Link
                  href="/programs#back-to-class"
                  className="mt-5 inline-flex items-center text-sm font-bold text-ink hover:underline"
                >
                  {h.learnMore}
                </Link>
              </div>
            ...
            {/* Image card 1 */}
            <div className="card-lift rounded-xl overflow-hidden relative min-h-[240px] group cursor-pointer">
              <Image
                src="/images/student_outside.png"
                alt="Child standing outside school"
                fill
            ...
            <div className="card-lift rounded-xl overflow-hidden relative min-h-[240px] group cursor-pointer">
              <Image
                ...
                alt="Child walking alone near a road"
                fill
                className="object-cover group-hover:scale-105 transition-transform duration-500"
              />
              <div className="img-card-overlay absolute inset-0" />
          ...
          <div className="mt-5 grid md:grid-cols-3 gap-5">
            ...
            {/* Colored category card — Program 02 */}
            <div className="rounded-xl bg-teal p-8 flex items-end min-h-[240px]">
              <div>
                ...
                <Link
                  href="/programs#steady-income"
                  className="mt-5 inline-flex items-center text-sm font-bold text-white hover:underline"
                >
                  {h.learnMore}
                </Link>
              </div>
